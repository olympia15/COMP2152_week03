...
# diceRange = range(1, 7) # creates a range of numbers
# diceList = list(diceRange) # prints the range as a list
...
i = 1
for w in weapons:
    print(f"{i}. {w}") # f means that it is a formatted string
    i += 1
...
while not isValid: # validating that the input is a number 1-6
